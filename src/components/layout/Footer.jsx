...
const translations = {
    fr: {
        ...
        madeWith: 'Inventé par Imane Taouss Badaoui',
        inMorocco: 'au Maroc'
    },
    ar: {
        ...
        madeWith: 'اخترعته إيمان طاوس بداوي',
        inMorocco: 'في المغرب'
    },
    en: {
        ...
        madeWith: 'Invented by Imane Taouss Badaoui',
                ...
                <div className="footer-main">
                    ...
                    <div className="footer-brand">
                        ...
                        <div className="social-links">
                            ...
                            <a href="https://www.instagram.com/imane369369/" target="_blank" rel="noopener noreferrer" className="social-link" aria-label="Instagram">
                                <svg viewBox="0 0 24 24" fill="currentColor">
